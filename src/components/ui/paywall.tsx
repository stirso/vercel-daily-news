...
export default function Paywall ({
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center gap-4 lg:gap-8 absolute left-0 bottom-0 h-full p-4 lg:p-8 bg-linear-to-t from-slate-800/90 via-gray-600/60 to-slate-300/40 z-5">
